  ...
  return (<>
    <div className="upper " id='Home' >
        <div className="mx-5" >
            ...
            <div style={{fontSize:"78px",fontWeight:"700",color:"var(--orange)"}}>Yogesh Saini</div>
            <div  style={{fontSize:"18px"}} className='lorem'><p>A passionate MERN STACK/FULL STACK DEVELOPER from India</p></div>
            <button style={{height:"40px"}} className='mybtn'>Contact Me</button>
        </div>
        <div >
    ...
    <Floating right="1360px" left="339px" image={crown} text="Full stack Software developer"/>
    <Floating right="930px" left="625px" image={thumsup} text="React Developer"/>
